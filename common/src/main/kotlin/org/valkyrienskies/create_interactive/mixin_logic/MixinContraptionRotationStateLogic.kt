...
object MixinContraptionRotationStateLogic {
    fun getRotationQuaternion(rotState: AbstractContraptionEntity.ContraptionRotationState, xRot: Float, yRot: Float, zRot: Float, dest: Quaterniond): Quaterniond {
