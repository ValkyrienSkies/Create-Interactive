    ...
    companion object {
        ...
        fun normalSticker(scene: SceneBuilder, util: SceneBuildingUtil) {
            ...
            scene.overlay.showControls(
                InputWindowElement(util.vector.blockSurface(BlockPos(0, 2, 2), Direction.UP), Pointing.DOWN)
                    .rightClick(),
                5
            )
            ...
            scene.overlay.showControls(
                InputWindowElement(util.vector.blockSurface(placePosVisually, Direction.UP), Pointing.DOWN)
                    .withItem(Items.OAK_PLANKS.defaultInstance)
                    .rightClick(),
                20
            )
            ...
            scene.overlay.showControls(
                InputWindowElement(util.vector.blockSurface(craftingPos, Direction.UP), Pointing.DOWN)
                    .rightClick(),
                20
            )
            ...
            scene.world.hideIndependentSectionImmediately(contraption)
            contraption =
