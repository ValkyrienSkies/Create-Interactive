...
class ShipHelmScreen(handler: ShipHelmScreenMenu, playerInventory: Inventory, text: Component) :
    ...
    override fun init() {
        ...
        disassembleButton.active = CreateInteractiveConfig.SERVER.allowDisassembly
        updateButtons()
    }
    ...
    private fun updateButtons() {
        ...
        disassembleButton.active = CreateInteractiveConfig.SERVER.allowDisassembly && isLookingAtShip
    }
    ...
    companion object { // TEXTURE DATA
        internal val TEXTURE = ResourceLocation(CreateInteractiveMod.MOD_ID, "textures/gui/ship_helm.png")
        ...
        private val ASSEMBLE_TEXT = TranslatableComponent("gui.create_interactive.assemble")
        private val DISSEMBLE_TEXT = TranslatableComponent("gui.create_interactive.disassemble")
        private val ALIGN_TEXT = TranslatableComponent("gui.create_interactive.align")
        private val ALIGNING_TEXT = TranslatableComponent("gui.create_interactive.aligning")
        private val TODO_TEXT = TranslatableComponent("gui.create_interactive.todo")
    }
}
